...
import { Plus, Search, AlertTriangle, Loader2, ExternalLink, Download, Package } from 'lucide-react';
...
export default function InventoryPage() {
  ...
  const handleRestock = async () => {
    ...
    setRestocking(true);
    try {
      await inventoryApi.restock(restockItem.id, { quantity: restockQty, unit_cost: restockCost });
      qc.invalidateQueries({ queryKey: ['inventory'] });
