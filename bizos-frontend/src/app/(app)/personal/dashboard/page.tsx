...
import {
  Bell, ArrowUpRight, ArrowDownLeft, PiggyBank,
  MoreHorizontal, Home, BarChart2, CreditCard, User,
  ShoppingBag, Utensils, Car, Zap, Heart,
} from 'lucide-react';
...
function getCategoryIcon(category: string) {
  return CATEGORY_ICONS[category.toLowerCase()] ?? <ShoppingBag size={16} />;
}
    ...
    <div style={{ width: '100%', minWidth: 0, paddingBottom: 24 }}>
            ...
            <div>
              ...
              <div style={{
                ...
                {isLoading ? (
                  ...
                  formatNaira(Math.abs(netSavings))
                )}
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Link
                ...
                style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  textDecoration: 'none', color: '#fff', fontSize: '1rem', lineHeight: 1,
                }}
              >
                +
              </Link>
      ...
      >
        {[
          ...
          { label: 'More',     icon: <MoreHorizontal size={20} />, href: '/personal/analytics',    color: '#6B7280' },
      ...
      {(foodDebt > 0 || titheDue > 0) && (
        ...
        >
          {foodDebt > 0 && (
            <Link href="/personal/food-vendor" style={{
          ...
          {titheDue > 0 && (
            <Link href="/personal/tithe" style={{
              flexShrink: 0, textDecoration: 'none',
              display: 'flex', alignItems: 'center', gap: 8,
              padding: '10px 16px', borderRadius: 14,
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 'var(--space-3)' }}>
          <h2 style={{ fontSize: 'var(--text-sm)', fontWeight: 800, color: 'var(--text-primary)' }}>
            Manage Expenses
          </h2>
          <Link href="/personal/transactions" style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          {(transactions as Array<{ id: string; type: string; category: string; amount: number; description?: string; transaction_date: string }>).map((tx) => {
